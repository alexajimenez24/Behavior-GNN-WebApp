...
export default function ParticipantSetup({ onComplete }) {
  ...
  return (
    <div style={{ height:'100vh', background:'#111b21', display:'flex', alignItems:'center', justifyContent:'center' }}>
      <div style={{ background:'#202c33', borderRadius:12, padding:'40px 48px', width:520, boxShadow:'0 8px 32px rgba(0,0,0,0.5)' }}>
        {/* Header */}
        <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:8 }}>
          ...
          <div>
            <div style={{ color:'#e9edef', fontWeight:600, fontSize:18 }}>Cognitive Research App</div>
            <div style={{ color:'#8696a0', fontSize:13 }}>Participant Setup</div>
          </div>
        </div>
        <div style={{ height:1, background:'#2a3942', margin:'20px 0' }} />
