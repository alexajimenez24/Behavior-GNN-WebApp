...
export default function ParticipantSetup({ onComplete }) {
  ...
  return (
    <div style={{ height:'100%', width:'100%', background:'#f0f2f5', display:'flex', alignItems:'center', justifyContent:'center' }}>
      <div style={{ background:'#ffffff', borderRadius:12, padding:'clamp(20px,4vw,40px) clamp(20px,5vw,48px)', width:'min(520px, 94vw)', maxHeight:'92dvh', overflowY:'auto', boxShadow:'0 8px 32px rgba(0,0,0,0.12)' }}>
